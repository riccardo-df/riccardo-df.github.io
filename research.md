...
><sub>*Empirical studies in various social sciences often involve discrete outcomes with inherent ordering, such as self-evaluations of subjective well-being and self-assessments in health domains. While ordered choice models are a popular tool for analyzing such outcomes, commonly used estimators impose restrictive parametric and distributional assumptions. This paper proposes a novel estimator, the modified ordered random forest, which overcomes these limitations. Under an "honesty" condition, predictions are consistent and asymptotically normal. The weights induced by each forest are used to estimate the variance of the predictions and obtain estimation and inference about the covariates' marginal effects. Evidence from synthetic and real data sets shows that the proposed estimator features a superior prediction performance than alternative estimators.*
